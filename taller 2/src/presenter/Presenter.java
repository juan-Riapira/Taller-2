 ...
 */
	public Presenter() {
		...
		serviceSale = new ServiceSale(null, 0);
	     ...
	     product4 = new Product("acetaminofen",2500,11,false, ETypeProduct.RANCHO);
	     product5 = new Product("acetaminofen",2500,11,false, ETypeProduct.LICORES);
	}
	 ...
	 * @return double
	 */
	   public double addSale(String name ,double valor,int cant, boolean iva, ETypeProduct eTypeProduct) {
	        ...
	        Sale sale = new Sale(cant, product);
